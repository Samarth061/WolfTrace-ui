  ...
  return (
    <header className="relative flex min-h-[70vh] flex-col items-center justify-center px-6 py-24 text-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <h1 className="font-[family-name:var(--font-dunerise)] text-6xl font-bold tracking-tight text-foreground md:text-8xl text-balance">
          WolfTrace
        </h1>

        <p className="mt-4 font-[family-name:var(--font-dunerise)] text-xl italic text-[#A17120] md:text-2xl">
          Trace the truth through the fog.
        </p>

        <a
          href="#submit-tip"
          className="mt-10 inline-flex items-center rounded-sm border border-[#A17120]/40 bg-[#A17120]/10 px-8 py-3 font-sans text-sm font-semibold tracking-wide text-[#A17120] transition-all duration-300 hover:bg-[#A17120]/20 hover:border-[#A17120]/60 hover:scale-105 hover:shadow-lg hover:shadow-[#A17120]/20 active:scale-95"
        >
          File a Tip
        </a>
      </div>
